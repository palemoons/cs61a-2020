...
def play(
    ...
    while True:
        if who == 0:
            ...
            if feral_hogs and abs(delta0 - num_rolls) == 2:
                delta0 = take_turn(num_rolls, score1, dice)
                score0 += delta0 + 3
            else:
                delta0 = take_turn(num_rolls, score1, dice)
                score0 += delta0
            ...
            if feral_hogs and abs(delta1 - num_rolls) == 2:
                delta1 = take_turn(num_rolls, score0, dice)
                score1 += delta1 + 3
            else:
                delta1 = take_turn(num_rolls, score0, dice)
                score1 += delta1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def func(score0, score1):
        ...
        if gain > running_high:
            ...
            highst = running_high
        return announce_highest(who, score, highst)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_num_rolls = 0
    for i in range(1, 11):
        average_score = make_averaged(roll_dice, trials_count)(i, dice)
        if max_average < average_score:
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    player_score = score + free_bacon(opponent_score)
    bacon_num_rolls = bacon_strategy(score, opponent_score, cutoff, num_rolls)
